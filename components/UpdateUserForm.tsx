...
function UpdateUserForm() {
  ...
  return (
    ...
    >
      ...
      <button className="flex justify-center text-base w-2/6 bg-yellow-400 text-white px-4 py-2 border rounded-md hover:bg-gray-50 hover:border-green-500 hover:text-green-500">
        Update <RefreshIcon className="h-4 ml-1 w-4 mt-1" />
      </button>
    </form>
  );
}
